...
#
# zcu111_custom_pfm.tcl: Tcl script for re-creating project 'zcu111_custom_pfm'
#
# Generated by Vivado on Fri Sep 29 11:45:39 AEST 2023
...
#
# 1. This project restoration tcl script (zcu111_custom_pfm.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/rick/Desktop/git/hw_platform/zcu111_custom_pfm/zcu111_custom_pfm.srcs/sources_1/bd/zcu111_custom_pfm/zcu111_custom_pfm.bd"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/zcu111_custom_pfm/zcu111_custom_pfm.srcs/sources_1/bd/zcu111_custom_pfm/zcu111_custom_pfm.bd"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "zcu111_custom_pfm"
...
set script_file "zcu111_custom_pfm.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/zcu111_custom_pfm"]"
...
set_property -name "platform.name" -value "zcu111_custom_platform" -objects $obj
...
if { [get_property IS_LOCKED [ get_files -norecurse zcu111_custom_pfm.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/zcu111_custom_pfm/zcu111_custom_pfm.gen/sources_1/bd/zcu111_custom_pfm/hdl/zcu111_custom_pfm_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse zcu111_custom_pfm.bd] -top]
...
set file "zcu111_custom_pfm/zcu111_custom_pfm.bd"
...
set_property -name "pfm_name" -value "xilinx:zcu111:zcu111_custom_platform:0.0" -objects $file_obj
...
set_property -name "top" -value "zcu111_custom_pfm_wrapper" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/zcu111_custom_pfm.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/zcu111_custom_pfm.srcs/utils_1/imports/impl_1" -objects $obj
